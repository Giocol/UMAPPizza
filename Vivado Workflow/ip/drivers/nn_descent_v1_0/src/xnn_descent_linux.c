...
typedef struct {
    ...
    XNn_descent_uio_map maps[ MAX_UIO_MAPS ];
} XNn_descent_uio_info;

/***************** Variable Definitions **************************************/
static XNn_descent_uio_info uio_info;
...
static int uio_info_read_name(XNn_descent_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XNn_descent_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XNn_descent_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XNn_descent_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XNn_descent_Initialize(XNn_descent *InstancePtr, const char* InstanceName) {
	XNn_descent_uio_info *InfoPtr = &uio_info;
